...
/**
 * Implements a hash table which maps key represented as longs to values represented as longs.
 * <p>
 * Use a {@link LargeSymbolTable} to map string constants or other values to long values.
 */
